...
public class UserMainActivity  extends FragmentActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.item1:
                ...
                switchFragment(current, userMainFragment);
                break;
            case R.id.item2:
        ...
        logoutDialog.setPositiveButton("确定",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        UserMainActivity.super.onBackPressed();
                    }
                });;
